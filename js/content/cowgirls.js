...
<div class="row1">
    ...
    <center>
        <h1 class="extra"><u><cufon class="cufon cufon-canvas" alt="National " style="width: 144px; height: 26px;"><canvas width="180" height="33" style="width: 180px; height: 33px; top: -6px; left: -2px;"></canvas><cufontext>National </cufontext></cufon><cufon class="cufon cufon-canvas" alt="Cowgirl " style="width: 134px; height: 26px;"><canvas width="170" height="33" style="width: 170px; height: 33px; top: -6px; left: -2px;"></canvas><cufontext>Cowgirl </cufontext></cufon><cufon class="cufon cufon-canvas" alt="Museum" style="width: 116px; height: 26px;"><canvas width="136" height="33" style="width: 136px; height: 33px; top: -6px; left: -2px;"></canvas><cufontext>Museum</cufontext></cufon></u></h1>
    </center>
</div>
<div class="row2">
    <strong></strong>
    ...
    <p></p>
    <p align="justify">I visited the <a href="http://www.cowgirl.net" target="_blank"><strong><u>National Cowgirl Museum</u></strong>
            <u></u></a> located in Forth Worth, so I took some pictures and thought
        I would make this page in case some of you ever wanted to visit it or if you
        could not visit - you could see some of the inside. Enjoy!</p>
    <p></p>
    <hr>
    <p></p>
    <p></p>
    <center>
        <img border="0" height="350" src="images2/cgm buck ride.JPG" width="200">
    </center>
    <p></p>
    <center>
    ...
    <p></p>
    <center>
        <img border="0" height="400" src="images2/cgm horse ride.JPG" width="250">
    </center>
    <p></p>
    <center>
    ...
    <hr>
    <p></p>
    <p align="justify">Hope you enjoyed this, while I was visiting here they had a
        group of young cowgirls singing and doing a live show of old west cowboy
        songs. If you are every in Forth Worth, I would say drop by, it is free and
        fairly small and would not take more than an hour or so to see it.</p>
    <p></p>
    <hr>
    <p></p>
    <div align="right" class="toplink">
        <a href="cowgirls.html#">Move to top of page <img alt="" border="0" height="12" src="up.gif" width="13"></a>
    </div>
    <h1 class="style1"></h1>
</div>
`;
